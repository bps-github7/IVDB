...
async function release(context, options, payload) {
    ...
    const fullDeployment = deploymentPlanner_1.createDeploymentPlan(payload.functions.backend, await backend.existingBackend(context), context.filters);
    ...
    track_1.default("functions_codebase_deploy", tag, functions.length);
