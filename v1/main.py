"""Main module for videogame database application
"""
...
### This should go in the management facade.
# def create_game():
...
Presents the user with options
    ...
    opt = ["1. Enter a videogame","2. Enter a rating for videogame",
           "3. Display videogames on record"]
    if admin:
...
and True to continue looping. otherwise,
executes actions correspondent with
the user's input (choice argument)
    """
